...
from .overlay_controls import overlay_controls
from .download_tar import TarDownloader
...
def start_gradio_viewer():
    ...
    def download_and_overlay():
        ...
        overlay_controls(controls_file, temp_video_out, video_path=video_file)
